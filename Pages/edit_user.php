        ...
        <div class="container mx-auto mt-8 p-8 bg-white shadow-md max-w-md">
            ...
            <form method="post" action="edit_user.php">
                ...
                <div class="mb-4">
                    ...
                    <select name="verified" required class="mt-1 p-2 border rounded-md w-full"
                        value="<?php echo $user->getVerified(); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="text" value="<?php echo $user->getFullName(); ?>" required
                        class="mt-1 p-2 w-full border rounded-md">
                </div>
                <div class="mb-4">
                    <label for="tel" class="block text-sm font-semibold text-gray-600">Phone Number:</label>
                    <input type="tel" name="tel" value="<?php echo $user->getphoneNumber(); ?>" required
                        class="mt-1 p-2 w-full border rounded-md">
                </div>
                <div class="mb-4">
                    <label for="address" class="block text-sm font-semibold text-gray-600">Address:</label>
                    <input type="address" name="address" value="<?php echo $user->getAddress(); ?>" required
                        class="mt-1 p-2 w-full border rounded-md">
                </div>
                <div class="mb-4">
                    <label for="text" class="block text-sm font-semibold text-gray-600">City:</label>
                    <input type="text" name="text" value="<?php echo $user->getCity(); ?>" required
                        class="mt-1 p-2 w-full border rounded-md">
                </div>
                <button type="submit"
