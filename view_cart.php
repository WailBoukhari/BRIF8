...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['checkout'])) {
    ...
    foreach ($cart as $cartItem) {
        ...
        $orderDetail = new OrderDetail($userData['user_id'], $orderId, $cartItem['product_id'], $cartItem['quantity'], $productData['final_price'] ?? 0, $cartItem['quantity'] * $productData['final_price']);
        ...
        <table class="w-full border-collapse border border-gray-300">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border border-gray-300 p-2">$<?php echo $cartItem['quantity'] * $cartItem['price']; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
